...
class SessionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'authentication_token' => ['type' => 'string', 'length' => 255, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'fixed' => null],
        'last_sign_in_at' => ['type' => 'timestamp', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
